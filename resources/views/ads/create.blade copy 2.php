            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ads.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="justification_compitences" class="col-md-4 col-form-label text-md-right">{{ __('Justification Compitences') }}</label>

                            <div class="col-md-6">
                                <input id="justification_compitences" type="text" class="form-control @error('justification_compitences') is-invalid @enderror" name="justification_compitences[]" value="{{ old('justification_compitences') }}" autocomplete="justification_compitences">
                                <small class="form-text text-muted">Enter each justification on a new line.</small>

                                @error('justification_compitences')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
