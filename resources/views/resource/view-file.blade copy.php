                    ...
                    <div class="card-body">
                        @if (strpos($mimeType, 'video') !== false)
                            ...
                            <video id="videoPlayer" width="100%" height="auto" controls>
                                <source src="{{ route('resource.view_fileinCader', ['id' => $resource->id]) }}" type="{{ $resource->mime_type }}">
                        ...
                        @elseif (strpos( $mimeType, 'pdf') !== false)
                            ...
                            <embed class="pdf-embed" src="{{ route('resource.view_fileinCader', ['id' => $resource->id]) }}" type="{{ $resource->mime_type }}">
